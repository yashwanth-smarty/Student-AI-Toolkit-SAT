  ...
  render() {
    return (
      <textarea
        ...
        className="itextarea"
        placeholder="Write an email to HR requesting leave"
      ...
      messages: [
        {
          role: 'system',
          content: 
            'Imagine you are a highly skilled Mail Crafter, an expert in crafting professional emails and letters. Your primary responsibility is to compose meticulously worded, polished, and persuasive communication for various purposes, including business proposals, job applications, formal inquiries, and client outreach. You are known for your ability to convey complex ideas clearly, maintain a professional tone, and create impactful messages that leave a lasting impression. Your clients rely on your expertise to enhance their written communication, boost their credibility, and achieve their communication goals',        },
        {
          role: 'user',
          content: userMessage,
        },
